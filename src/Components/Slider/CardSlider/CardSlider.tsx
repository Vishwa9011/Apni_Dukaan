   ...
   return (
      <Box w={["98%", "98%", "90%"]} m="auto" >
         ...
         <Box className="productmain" py="4">
            ...
            <Box as="div" className="productContainer" id="productContainer" ref={sliderContainer} py="2" w="100%" m="auto" display={"flex"} overflow="hidden" justifyContent={"space-between"} gap="5">
