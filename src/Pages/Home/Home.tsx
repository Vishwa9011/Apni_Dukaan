...
function Home() {
 return (
          <Box>
               <MainSlider/>
               <Box mt="5">
                    <Image src="https://images.bewakoof.com/uploads/grid/app/Desktop-Strip-6-1669115141.jpg"/>
               </Box>
               {/* <Center mt="2" >
               ...
               <Center mt="10" mb="5">
                    ...
                    <Image h="250" src="https://images.bewakoof.com/uploads/grid/app/new-thumbnail-icon-2022-bestseller-1671624963.jpg"/>
                    <Text>Bestsellers</Text>
                    </Box>
                    <Box alignItems={"center"} textAlign="center">
                    <Image h="250"src="https://images.bewakoof.com/uploads/grid/app/Thumbnail-New-Arrivals-Common-1668508339.jpg"/>
                    <Text>Bestsellers</Text>

                    </Box>
                    <Box alignItems={"center"} textAlign="center">
                    <Image h="250" src="https://images.bewakoof.com/uploads/grid/app/hotdeals-2-1668491210.jpg"/>
                    <Text>Bestsellers</Text>

                    </Box>
                    <Box alignItems={"center"} textAlign="center">
                    <Image h="250" src="https://images.bewakoof.com/uploads/grid/app/Thumbnail-Collabs-Common-1668508338.jpg"/>
                    <Text>Bestsellers</Text>

                    </Box>
                    <Box alignItems={"center"} textAlign="center">
                    <Image h="250" src="https://images.bewakoof.com/uploads/grid/app/last-size-new-thumbnaik-1668508337.jpg"/>
                    <Text>Bestsellers</Text>

                    </Box>
                    <Box alignItems={"center"} textAlign="center">
                    <Image h="250" src="https://images.bewakoof.com/uploads/grid/app/new-thumbnail-icon-2022-copy-1669723278.jpg"/>
                    <Text>Bestsellers</Text>
